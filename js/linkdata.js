...
const linkData = [
    ...
    },
    {
        ...
        desc: "楽しく、わかりやすい事を心がけてます。たべラボ、心理支援者の集い、🌈RIESM™で活動されています。"
    },
    {
        name: "こぐみ",
    ...
    {
        name: "あきこ",
        avatar: { text: "あ", color: "trust" },
        title: "たべラボメンバー",
        tags: ["tabelab"],
        desc: "たべラボメンバーとして活動・発信されています。紹介文やリンクは、掲載情報が揃い次第更新します。"
    },
    {
