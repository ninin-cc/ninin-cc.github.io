...
const QUESTIONS_CAREER = [
  {
    ...
    "pastExam": {
      ...
      "answer": "1",
      "explanation": "ハンセンの統合的人生設計（ILP）における4Lは、Labor（労働）、Love（愛）、Learning（学習）、Leisure（余暇）です。これらをパッチワーク・キルトのように統合してキャリアを設計することの重要性を説きました。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "2",
      "explanation": "ホランドは個人のパーソナリティと働く環境をRIASEC（現実的、研究的、芸術的、社会的、企業的、慣習的）の6タイプに分類しました。選択肢1はスーパー、3はギンズバーグ、4はジェラットの理論です。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "3",
      "explanation": "パーソンズの特性因子理論の3ステップは「自己理解」「職業理解」「合理的な推論（マッチング）」です。「意味への意志」はフランクルのロゴセラピーにおける中心概念です。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "3",
      "explanation": "キャリア・アンカーは自覚された「才能と能力」「動機と欲求」「意味と価値（価値観）」の3要素から構成されます。個人の自己概念の中核であり、一度形成されると簡単には変化しないとされています。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "4",
      "explanation": "シュロスバーグの4Sは、Situation（状況）、Self（自己）、Support（支援）、Strategies（戦略）の4つを指します。Skill（スキル）は含まれません。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "3",
      "explanation": "偶然をチャンスに変える5つのスキルは、好奇心（Curiosity）、持続性（Persistence）、柔軟性（Flexibility）、楽観性（Optimism）、冒険心（Risk-taking）です。計画性は含まれていません。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "2",
      "explanation": "スーパーは、キャリアの発達とは自己概念（自分がどのような人間であるか）を形成し、職業を通してそれを実現していくプロセスであると定義しました。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "3",
      "explanation": "キャリア・アダプタビリティの4つの次元（4C）は、Concern（関心）、Control（統制）、Curiosity（好奇心）、Confidence（自信）です。Compromise（妥協）は含まれません。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "4",
      "explanation": "バンデューラは、自己効力感を高める4つの情報源（遂行行動の達成、代理的体験、言語的説得、情動的喚起）のうち、自身が直接成功を収めた経験である「遂行行動の達成」が最も確実で影響力が大きいとしています。"
    }
  },
  {
    ...
    "pastExam": {
      ...
      "answer": "2",
      "explanation": "ギンズバーグは、個人の職業選択を「空想期（〜11歳頃）」「試行期（11〜17歳頃）」「現実期（17歳以降）」の3段階を経て発達していくものとして整理しました。選択肢3について、当初は「非可逆的」と主張していました。"
    }
  },
  {
  ...
  },
  {
    ...
    "activeCountryText": "ｱﾒﾘｶ",
    "lifespan": "1908 - 1970",
    "explanation": "マズローは人間の欲求を5段階に分類し、低次の欠乏欲求が満たされた後に、自己の潜在能力を最大限に発揮しようとする最も高次な「自己実現の欲求」が現れると考えました。",
    "works": [
      {
        "year": 1943,
  ...
  },
  {
    ...
    "activeCountryText": "ｱﾒﾘｶ",
    "lifespan": "1893 - 1970",
    "explanation": "エンプティ・チェア（空の椅子）技法は、自分の中にある葛藤や、他者への未解決な感情（未完の体験）に直面し、気づきを得るためにゲシュタルト療法でよく用いられます。",
    "works": [
      {
        "year": 1951,
        "title": "『Gestalt Therapy』刊行"
